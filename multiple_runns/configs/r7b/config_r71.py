...
PORT = 3101
RUN_FOLDER = "~/Documents/Thesis_work/results/r7b/" # use if ~/ outside gymtorcs folder
RUN_NAME = "r71b" # name added to runfolder
...
SC_VERSION = 2
SAFETY_GAMMA = 0.99 # γ discount for penaltys only
